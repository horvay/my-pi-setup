...
|---|---|---|
| Context | The PRODUCT.md / DESIGN.md loader result is known from `node $HOME/.pi/agent/skills/impeccable/scripts/load-context.mjs`. | Run the loader before continuing. |
...
```bash
node $HOME/.pi/agent/skills/impeccable/scripts/pin.mjs <pin|unpin> <command>
```
